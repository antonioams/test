...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Tela Inicial</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/inicial/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
