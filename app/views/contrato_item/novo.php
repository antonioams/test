...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Itens do Contrato</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/contrato_item/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
