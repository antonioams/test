...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Itens do Contrato</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/contrato_item/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  ...
  <th></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdcontrato') ? "style='display:none'" : "" )?>>Contrato</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'descricao') ? "style='display:none'" : "" )?>>Descrição</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdunidade') ? "style='display:none'" : "" )?>>Unidade Medida</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'quantidade') ? "style='display:none'" : "" )?>>Quantidade</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'valor') ? "style='display:none'" : "" )?>>Valor</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'data') ? "style='display:none'" : "" )?>>Data Entrega</div></th>
   ...
   <td><input type="checkbox" checked="checked" /></td>
    <td>
<div <?php echo ( ($view_vc[0]['chave'] == 'cdcontrato') ? "style='display:none'" : "" )?>>
<select id="cdcontrato" name="cdcontrato[]" data-parsley-trigger="change">
  <option value=""></option>
 <?php
...
<input id="quantidade" name="quantidade[]" type="text" value="<?php echo $_POST['quantidade']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Quantidade" data-parsley-type="digits"/>
</div>
</td><td>
