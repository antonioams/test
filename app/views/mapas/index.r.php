        ...
        <script>
			...
			foreach ($view_projetos as $projetos) {
				if ($projetos['flicker']!=null){
					...
					?>
					//var img='<img class="avatar avatar-lg img-thumbnail " title="<?=$fotos['photoset']['photo'][0]['title']?>" src="http://farm<?=$fotos['photoset']['photo'][0]['farm']?>static.flickr.com/<?=$fotos['photoset']['photo'][0]['server']?>/<?=$fotos['photoset']['photo'][0]['id']?>_<?=$fotos['photoset']['photo'][0]['secret']?>_m.jpg"  alt=""';
					//flicker_array = flicker_array+"['<?=$projetos['cdprojeto']?>',img],";
					...
					var src="http://farm<?=$fotos['photoset']['photo'][0]['farm']?>.static.flickr.com/<?=$fotos['photoset']['photo'][0]['server']?>/<?=$fotos['photoset']['photo'][0]['id']?>_<?=$fotos['photoset']['photo'][0]['secret']?>_m.jpg";
					var title="<?=$fotos['photoset']['photo'][0]['title']?>";
					if (flicker_array=='')
						flicker_array=flicker_array+'{"cdprojeto":<?=$projetos['cdprojeto']?>,"src_flicker":"'+src+'","title_flicker":"'+title+'"}';
					else
						flicker_array=flicker_array+',{"cdprojeto":<?=$projetos['cdprojeto']?>,"src_flicker":"'+src+'","title_flicker":"'+title+'"}';
					<?php
				}	
    ...
    <body onload="initialize()">
        <div class="container">
            <header class="clearfix topo">
                <?php echo '<img src="/'.PROJETO.'/inc/img/cliente/c'.$view_cliente[0]['cdcliente'].'.png" alt="">'; ?>
                <nav class="">
                </nav>
            </header>
