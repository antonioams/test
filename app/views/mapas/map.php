            ...
            <script>
                $(document).ready(function(){
                    ...
                    $(".icon-location-circled").click(function(){
                        ...
                        $(".texto").html('<h4>Categorias</h4><img src="/<?php echo PROJETO;?>/sighomologa/inc/img/saude.jpg" class="mincir" width="64px"><img src="educacao.jpg" class="mincir" width="64px"><img src="saneamento.jpg" class="mincir" width="64px"> <img src="transporte.jpg" class="mincir" width="64px">');
                        $("#menulateral").show();
                    });
