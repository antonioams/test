						...
						<ul>
						   <li class='active has-sub'><a href='#'><span>Informações</span></a>
						      <ul>
						       ...
						       <!--  <li><a href="/<?php echo PROJETO;?>/gconsulta/gerar_p/id/<?php echo $consultas['cdconsulta']?>" target="_BLANK"><span><?php echo $consultas['titulo'];?></span></a> -->
...
<div class="modal" id="<?php echo $consultas['cdconsulta']?>" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
      <p><iframe src="/<?php echo PROJETO;?>/gconsulta/gerar_p/id/<?php echo $consultas['cdconsulta']?>" style="width: 98%; min-height: 500px;" frameborder="0"></iframe></p>
    </div>
...
<iframe src="/<?php echo PROJETO?>/mapas/galeria/" style="width: 100%; min-height: 500px;" frameborder="0"></iframe>
    ...
    <div class="modal" id="contato" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-header">
      <h2>Contato</h2>
      <a href="#close" class="btn-close" aria-hidden="true">×</a> <!--CHANGED TO "#close"-->
...
#formcontato .send{
	...
	border: 0px;
			...
			<form method="POST" id="formcontato" action="envia.php">
				<label>Digite seu nome:
					<input type="text" name="nome" value="" placeholder="ex: Jo�o" required >
				</label>
				<label>Digite seu e-mail:
					<input type="email" name="email" value="" placeholder="ex: seu@email.com" required >
				</label>
				<label>Digite o assunto:
					<input type="text" name="assunto" value="" placeholder="Diga o que deseja!" required >
				</label>
				<label>Digite sua mensagem:
					<input type="text" name="msg" value="" placeholder="Digite sua mensagem aqui" required >
				</label>
				
				<!-- Div do ReCaptcha foi adicionado no final do formul�rio -->
				<div class="g-recaptcha" data-sitekey="6Lf-1RkTAAAAAFOZm1YI4QOb2rezD8YaKNw9bUWd"></div>	
		</div>
    </p>
    </div>
    <div class="modal-footer">
