...
// seleciona as saida 
  ...
  $sqlsaida = "select e.entidade ||'.'|| c.campo as nome, s.tipo, c.legenda, s.cdsaida, s.chave, s.visualiza, s.rotulo, s.totaliza from modulo e, modulo_campo c, saida s
           where e.cdmodulo=c.cdmodulo and c.cdcampo=s.cdcampo and s.cdconsulta=".$vconsulta ."  order by s.rotulo, s.cdsaida";
...
$i=0;
 ...
 $tabelav.= ' <tr>';
  ...
  if ($detalhes_consultas[0]['grafico']=='6') {
       ...
       if ($saida['rotulo']=='1') {
           $rot[] = $con[$saida['cdsaida']];
      }

      if ($saida['totaliza']=='1') {
        $tot[] = $con[$saida['cdsaida']];
      }
    }
...
';
  ...
  if ($detalhes_consultas[0]['grafico']=='6') {
     ...
     $vgrafico .= '
                                      ...
                                      <div class="col-sm-12 mb25">
                                          <div class="piechart">
                                                <span class="visits2" data-percent="50">
                                                <span>
