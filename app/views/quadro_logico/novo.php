...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Itens do Quadro Lógico</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/quadro_logico/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
