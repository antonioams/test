...
<form action="/<?php echo PROJETO;?>/wquadro/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Código</th><th>Lógica</th><th>Tipo</th><th>Indicador</th><th>Fórmula</th><th>Fontes</th><th>Descrição do Indiciador</th><th>Area</th><th>Nivel</th>
  </tr>
  </thead>
   <tbody>
   <tr>
   <td><input type="checkbox" checked="checked" /></td>
    <td>
<input id="cdquadro_logico" name="cdquadro_logico[]" type="text" value="<?php echo $_POST['cdquadro_logico']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Código" data-parsley-type="digits"/>
</td><td>
