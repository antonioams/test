...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Situações</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/situacao/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'descricao') ? "style='display:none'" : "" )?>>Descrição</div></th>
  </tr>
  </thead>
   <tbody>
   <tr>
