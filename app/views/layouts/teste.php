            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="wrapper">
                        <div class="row mg-b">
                            <div class="col-xs-12">
                                <h5 class="text-uppercase no-m">Tabs &amp; <b>Accordions</b></h5>
                                <ol class="breadcrumb small bg-none no-p">
                                    <li>
                                    ...
                                    <li class="active">Tabs &amp; <b>Accordions</b>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 panel">
                                <h4><i class="fa fa-user"></i> Configurações do Cliente:</h4>
                                    <div class="panel-body col-md-12 widget">
                                    ...
                                    <div class="panel-body col-md-12" >
                                      <div id="tudo">
                                        ...
                                        <form>                            
                                            ...
                                            <input type="hidden" value="#1582dc" id="topo"> 
                                            <input type="hidden" value="#cad0dd" id="textot">
                                            <input type="hidden" value="#4f5061" id="menu"> 
                                            <input type="hidden" value="#cad0dd" id="tmenu"> 
                                            <input type="hidden" value="#f1f4f9" id="pagina">
                                            <input type="hidden" value="#777777" id="texto">
                                            <input type="hidden" value="#777777" id="mcon">
                                            <input type="hidden" value="#777777" id="mfonte">
                                        <div class="panel-body col-md-12 widget bordered"  >
