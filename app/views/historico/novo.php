...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Histórico</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/historico/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<div class="controls">
<div class="row"><div class="col-xs-4"><input id="datahora" name="datahora" type="text" value="<?php echo $_POST['datahora']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Datahora"/></div></div>
</div></div>
