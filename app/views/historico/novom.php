...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Histórico</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/historico/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Tabela</th><th>Descrição</th><th>Datahora</th>
  </tr>
  </thead>
   <tbody>
   <tr>
...
<input id="datahora" name="datahora[]" type="text" value="<?php echo $_POST['datahora']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Datahora"/>
