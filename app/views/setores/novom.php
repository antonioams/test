...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Setores</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/setores/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Cliente</th><th>Nome</th><th>Descrição</th>
  </tr>
  </thead>
   <tbody>
   <tr>
