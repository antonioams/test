...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Checklist</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/grupo_documento/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'descricao') ? "style='display:none'" : "" )?>>Descrição</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdfase') ? "style='display:none'" : "" )?>>Fase</div></th>
  </tr>
  </thead>
   <tbody>
   <tr>
...
<div <?php echo ( ($view_vc[0]['chave'] == 'cdfase') ? "style='display:none'" : "" )?>>
