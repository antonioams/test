...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Aditivos do Contrato</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/aditivos/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Contrato</th><th>Data</th><th>Prazo</th><th>Valor</th>
  </tr>
  </thead>
   <tbody>
   <tr>
