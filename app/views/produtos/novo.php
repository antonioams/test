...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Produtos/Serviços</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/produtos/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<div class="controls">
<div class="row"><div class="col-xs-12"><input id="logica" name="logica" type="text" value="<?php echo $_POST['logica']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Logica"/></div></div>
</div></div>
