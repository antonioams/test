...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Previsão do Item</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/contrato_previsao/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<div class="controls">
<div class="row"><div class="col-xs-4"><input id="sequencia" name="sequencia" type="text" value="<?php echo $_POST['sequencia']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Sequencia" data-parsley-type="digits"/></div></div>
</div></div>

<div class="form-group"  <?php echo ( ($view_vc[0]['chave'] == 'quantidade') ? "style='display:none'" : "" )?>>
<label  class="control-label">Quantidade</label>
<div class="controls">
<div class="row"><div class="col-xs-4"><input id="quantidade" name="quantidade" type="text" value="<?php echo $_POST['quantidade']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Quantidade"/></div></div>
</div></div>
