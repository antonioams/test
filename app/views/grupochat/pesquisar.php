...
<section class="panel">
<header class="panel-heading">Pesquisar Grupo Chat</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/grupochat/pesquisa/" role="form" method="post" name="formpesquisa" class="parsley-form" data-parsley-validate>
...
<div class="controls">
<div class="row"><div class="col-xs-4"><input id="nome" name="s0nome" type="text" value="<?php echo $_POST['nome']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Nome do grupo"/></div></div>
</div></div>
