...
<form action="/<?php echo PROJETO;?>/saidas/pesquisa/" role="form" method="post" name="formpesquisa" class="parsley-form" data-parsley-validate>
...
<div class="controls">
 <div class="row"><div class="col-xs-12"><select class="chosen" id="tipo" name="m3tipo[]" multiple>
  <option value=""></option><option value="selecionar
somar
quantificar
maior valor
menor valor" <?php if ($_POST['tipo']=='selecionar
somar
quantificar
maior valor
menor valor') { echo 'selected';}?>>selecionar
somar
quantificar
maior valor
menor valor</option>
