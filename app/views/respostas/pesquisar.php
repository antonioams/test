...
<section class="panel">
<header class="panel-heading">Pesquisar Respostas</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/respostas/pesquisa/" role="form" method="post" name="formpesquisa" class="parsley-form" data-parsley-validate>
<div class="form-group">
<label  class="control-label">Código</label>
<div class="controls">
<div class="row"><div class="col-xs-3"><input id="cdresposta" name="i1cdresposta" type="text" value="<?php echo $_POST['cdresposta']; ?>" class="form-control number" /></div>
<div class="col-xs-3"><input id="cdresposta" name="i2cdresposta" type="text" value="<?php echo $_POST['cdresposta']; ?>" class="form-control number" /></div><div>
</div></div>

<div class="form-group">
<label  class="control-label">Pergunta</label>
<div class="controls">
 <div class="row"><div class="col-xs-12"><select class="chosen" id="cdpergunta" name="m3cdpergunta[]" multiple>
  <option value=""></option>
 <?php
 if (empty($view_perguntas[1])) { $ch=' selected="selected" '; }
