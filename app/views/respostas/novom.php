...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Respostas</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/respostas/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Pergunta</th><th>Descrição</th><th>Ordem</th>
  </tr>
  </thead>
   <tbody>
   <tr>
   <td><input type="checkbox" checked="checked" /></td>
    <td>
<select id="cdpergunta" name="cdpergunta[]" data-parsley-trigger="change">
  <option value=""></option>
 <?php
