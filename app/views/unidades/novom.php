...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Unidades de Medida</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/unidades/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
