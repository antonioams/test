...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Tipo de Projeto</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/tipos/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
