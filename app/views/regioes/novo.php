...
<section class="panel">
<header class="panel-heading">Cadastrar Novo Regiões</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/regioes/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
