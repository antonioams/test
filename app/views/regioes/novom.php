...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Regiões</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/regioes/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
