...
<section class="panel">
<header class="panel-heading">Cadastrar Novos G. Questionários</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/grupos/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
