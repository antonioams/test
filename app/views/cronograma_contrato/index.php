        ...
        <div class="table-responsive no-border">
                          ...
                          <table class="table table-bordered no-m">
                                            ...
                                            for($i = 0; $view_mesf.'/'.$view_anof != $mes.'/'.$ano; ++$i) {
                                              ...
                                              $previsao_item_valor[$contratos['cdcontrato_item']] = $previsao_item_valor[$contratos['cdcontrato_item']] + $prev_valor ;
                                            ...
                                            ?>
                                                    ...
                                                    <div class="small"> <?php echo ( $previsao_item_quantidadema[$contratos['cdcontrato_item']][$ano][$mes] > 0 ? round($previsao_item_quantidade[$contratos['cdcontrato_item']]).' %' : '-' );?></div>
                                                        ...
                                                        <?php } ?>
                                                        <small><?php if($previsao_item_valorma[$contratos['cdcontrato_item']][$ano][$mes]>0){ echo 'R$ '.$previsao_item_valorma[$contratos['cdcontrato_item']][$ano][$mes];}?></small>
                                                    </td>                                                    
			                                      <?php                                                 
                                                 if ($mes<12) {
                                                    $mes=$mes+1;
                                            ...
                                            ?>
                                                    ...
                                                    <?php if($medicao_item_quantidadema[$contratos['cdcontrato_item']][$ano][$mes]>0){?>
                                                        <div class="progress progress-xs mt5 mb5">
                                                            <div style="width: <?php echo $medicao_item_quantidade[$contratos['cdcontrato_item']];?>%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="<?php echo $medicao_quantidade_item[$contratos['cdcontrato_item']];?>" role="progressbar" class="progress-bar<?php echo $mq;?> done">
                                                            
                                                            </div>
                                                        </div>
                                                        <?php } ?>
                                                        <small><?php if($medicao_item_valorma[$contratos['cdcontrato_item']][$ano][$mes]>0){ echo 'R$ '.$medicao_item_valor[$contratos['cdcontrato_item']]; } ?></small>
