...
<form action="/<?php echo PROJETO;?>/mensagem/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable" class="table table-bordered table-striped"> 
  ...
  <th></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdchatmensagem') ? "style='display:none'" : "" )?>>cdchatmensagem</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'mensagem') ? "style='display:none'" : "" )?>>mensagem</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdgrupo') ? "style='display:none'" : "" )?>>cdgrupo</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdusuario') ? "style='display:none'" : "" )?>>cdusuario</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'datahora') ? "style='display:none'" : "" )?>>datahora</div></th>
   ...
   <td>
    ...
    <td>
<div <?php echo ( ($view_vc[0]['chave'] == 'cdchatmensagem') ? "style='display:none'" : "" )?>>
<input id="cdchatmensagem" name="cdchatmensagem[]" type="text" value="<?php echo $_POST['cdchatmensagem']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="cdchatmensagem" data-parsley-type="digits"/>
</div>
</td><td>
