...
<section class="panel">
<header class="panel-heading">Cadastrar Novos G. Quadro Lógico</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/quadro/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
