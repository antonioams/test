...
<section class="panel">
<header class="panel-heading">Cadastrar Novo chatgrupoparticipante</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/chatgrupoparticipante/insere/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<div class="controls">
<div class="row"><div class="col-xs-4"><input id="cdchatgrupoparticipante" name="cdchatgrupoparticipante" type="text" value="<?php echo $_POST['cdchatgrupoparticipante']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="cdchatgrupoparticipante" data-parsley-type="digits"/></div></div>
</div></div>
