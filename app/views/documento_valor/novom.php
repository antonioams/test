...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Checklist de Documentos</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/documento_valor/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Projeto</th><th>Campo</th><th>Valor</th><th>Arquivo</th>
  </tr>
  </thead>
   <tbody>
   <tr>
...
<input id="arquivo" name="arquivo[]" type="text" value="<?php echo $_POST['arquivo']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Arquivo"/>
