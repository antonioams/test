...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Produtos do Projeto</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/projeto_produto/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdprojeto') ? "style='display:none'" : "" )?>>Projeto</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'cdproduto') ? "style='display:none'" : "" )?>>Produto/Serviço</div></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'peso') ? "style='display:none'" : "" )?>>Peso</div></th>
  </tr>
  </thead>
   <tbody>
   <tr>
...
<input id="peso" name="peso[]" type="text" value="<?php echo $_POST['peso']; ?>" class="form-control"  data-parsley-trigger="change" placeholder="Peso"/>
</div>
</td></tr>
</tbody></table> 
</div>
