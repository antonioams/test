...
<section class="panel">
<header class="panel-heading">Editar Produtos do Projeto</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/projeto_produto/atualiza/id/<?php echo $view_projeto_produto[0]['cdprojeto_produto'];?>" role="form" method="post" name="formeditar" class="parsley-form" data-parsley-validate>
...
<div class="controls">
 <div class="row"><div class="col-xs-12"><select class="chosen" id="cdprojeto" name="cdprojeto" data-parsley-trigger="change">
  <option value=""></option>
 <?php
 $vmarcado = ( empty( $_POST ) ) ? ( $view_projeto_produto[0]['cdprojeto'] ) : ( $_POST['cdprojeto'] ); 
...
<div class="controls">
 <div class="row"><div class="col-xs-12"><select class="chosen" id="cdproduto" name="cdproduto" data-parsley-trigger="change">
  <option value=""></option>
 <?php
 $vmarcado = ( empty( $_POST ) ) ? ( $view_projeto_produto[0]['cdproduto'] ) : ( $_POST['cdproduto'] ); 
...
<div class="controls">
<div class="row"><div class="col-xs-4"><input id="peso" name="peso" type="text" value="<?php echo ( empty( $_POST ) ) ? ( $view_projeto_produto[0]['peso'] ) : ( $_POST['peso'] ) ?>" class="form-control"  data-parsley-trigger="change" placeholder="Peso"/></div></div>
</div></div>
...
<a href="/<?php echo PROJETO;?>/projeto_produto/exclui/id/<?php echo $view_projeto_produto[0]['cdprojeto_produto'];?>"  class="btn btn-danger btn-sig"><i class=" fa fa-fw fa-times-circle"></i>
                    Excluir</a>
 </form>
  </div>
 </section>
