...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Natureza</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/naturezas/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th><div <?php echo ( ($view_vc[0]['chave'] == 'nome') ? "style='display:none'" : "" )?>>Nome</div></th>
  </tr>
  </thead>
   <tbody>
   <tr>
