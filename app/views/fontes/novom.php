...
<section class="panel">
<header class="panel-heading">Cadastrar Novos Fontes</header>
<div class="panel-body">

<form action="/<?php echo PROJETO;?>/fontes/inserem/" role="form" method="post" name="formnovo" class="parsley-form" data-parsley-validate>
...
<table id="dataTable1" class="table table-bordered table-striped"> 
  <thead>
  <tr>
  <th></th><th>Descrição</th><th>Nome</th>
  </tr>
  </thead>
   <tbody>
   <tr>
