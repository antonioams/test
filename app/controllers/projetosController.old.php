    ...
    class projetos extends Controller{
        ...
        public function Index_action(){
           ...
           //$projetos_lista = $projetos->listaprojetos("{$par}");
            $projetos_lista = $projetos->rsql("
                select p.*, a.nome as area, a.icone, t.nome as tipo, f.nome as fase from projeto p
        ...
        public function visualiza(){
            ...
            $detalhes_projetos = $projetos->rsql("
                ...
                n.nome as natureza, m.nome as municipio, pr.descricao as programa 
                from projeto p
                left outer join area a on p.cdarea=a.cdarea
                left outer join tipo t on p.cdtipo=t.cdtipo
                left outer join fase f on p.cdfase=f.cdfase
            ...
            $indicadores = $projetos->rsql("
                ...
                UNION ALL 
                SELECT 'medicao' AS indicador, cdprojeto, NULLIF(count(cdmedicao),0)FROM medicao  WHERE m.cdprojeto=".$id." GROUP BY cdprojeto
                ");
            $datas['indicadores'] = $detalhes_contratos;
