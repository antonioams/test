...
session_start();
    class programas extends Controller{
        ...
        public function consultar(){
            ...
            header( "Location: /".PROJETO."/programas/" );
        ...
        public function Index_action(){
            ...
            if ($programas->pacesso('visualizar',$_SESSION[PROJETO]['cdperfil'])=='1') {
                $this->view('/programas/index', $datas);
            } else {
        ...
        public function novo(){
           $programas = new programasModel();
           $datas['vc'] = $this->modvinculados(get_class($this));
            if ($programas->pacesso('inserir',$_SESSION[PROJETO]['cdperfil'])=='1') {    $this->view('/programas/novo', $datas);
            } else {
                $this->view('/erro/index', $datas);
            }
        }
        ...
        public function novom(){
           ...
           $datas['vc'] = $this->modvinculados(get_class($this));
            if ($programas->pacesso('inserir_mtp',$_SESSION[PROJETO]['cdperfil'])=='1') {
                $this->view('/programas/novom', $datas);
            } else {
                $this->view('/erro/index', $datas);
            }
        }
        ...
        public function editar(){
            ...
            if ($programas->pacesso('editar',$_SESSION[PROJETO]['cdperfil'])=='1') {
                $this->view('/programas/editar', $datas);
            } else {
                $this->view('/erro/index', $datas);
            }
        ...
        public function atualiza(){
            ...
            header( "Location: /".PROJETO."/programas/editar/id/{$id}" );
        ...
        public function pesquisar(){
            ...
            if ($programas->pacesso('pesquisar',$_SESSION[PROJETO]['cdperfil'])=='1') {
                $this->view('/programas/pesquisar', $datas);
            } else {
                $this->view('/erro/index', $datas);
            }
        }
        ...
        public function insere(){
            ...
            if ($_POST['submit']=='Salvar e Continuar') {
            header( "Location: /".PROJETO."/programas/editar/id/{$insere}" );
            } else {
            header( "Location: /".PROJETO."/programas/" );
            }
