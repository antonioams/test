...
session_start();
    class consultas extends Controller{
        ...
        public function Index_action(){
            ...
            $consultas_lista = $consultas->listaconsultas("cdcliente=".$_SESSION[PROJETO]['cdcliente']." and cdconsulta in (select cdconsulta from perfil_consulta where cdperfil=".$_SESSION[PROJETO]['cdperfil'].")");
        ...
        public function exclui(){
            ...
            $atualiza2 = $perfil_consulta->excluiperfil_consulta( 'cdconsulta='.$id );            
            $atualiza3 = $saidas->excluisaidas( 'cdconsulta='.$id );
            $atualiza4 = $parametros->excluiparametros( 'cdconsulta='.$id );
        ...
        public function insere(){
            ...
            $_POST['cdcliente']=$_SESSION[PROJETO]['cdcliente'];
            $insere = $consultas->insereconsultas($_POST, 'cdconsulta');
                        
            $dadosconsulta['cdconsulta']=$insere;
            $dadosconsulta['cdperfil']=$_SESSION[PROJETO]['cdperfil'];
                        
            $insere2 = $perfil_consulta->insereperfil_consulta($dadosconsulta,'cdperfil_consulta');
