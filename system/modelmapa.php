...
session_start();
    ...
    class Modelmapa{
        ...
        try {
		     ...
		     if ($this->_conexao=='2') {
            $this->_db = new PDO('pgsql:host=localhost;dbname='.PROJETO.$_SESSION[PROJETO]['clientemapa'], 'postgres', 'post82');
        ...
        public function rssql( $sql, $conex = '2' ){
            if ($conex=='2') {
            $this->_dbc = new PDO('pgsql:host=localhost;dbname='.PROJETO.$_SESSION[PROJETO]['clientemapa'], 'postgres', 'post82');
            } else {
        ...
        public function listcol($tab, $conexaog){
          ...
          if ($conexaog=='2') {
                $db = new PDO('pgsql:host=localhost;dbname='.PROJETO.$_SESSION[PROJETO]['clientemapa'], 'postgres', 'post82');
            } else {
